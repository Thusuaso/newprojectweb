...
export default {
  ...
  methods: {
    ...
    isAllSelected() {
      if (this.isAll == true) {
        this.$store.dispatch("datatableLoadingBeginct")

        service.getYuklemeAllAll().then((data) => {
          this.$store.dispatch("stok_rapor_list_load_act", data);
          this.ilk_tarih = false;
          this.son_tarih = false;
          this.is_excel = false;
    ...
    YilSecim(select_yil) {
      ...
      service.getSevkiyatRaporTekTarihAll(select_yil).then((data) => {
        this.$store.dispatch("stok_rapor_list_load_act", data);
        this.loading = false;
        this.ilk_tarih = false;
        this.son_tarih = false;
    ...
    rapor_tarih_suz_click() {
      if (this.son_tarih && !this.ilk_tarih) {
        ...
        service.getSevkiyatRaporTarihAll(tarih).then((data) => {
          this.$store.dispatch("stok_rapor_list_load_act", data);
          this.$store.dispatch("datatableLoadingEndAct")
