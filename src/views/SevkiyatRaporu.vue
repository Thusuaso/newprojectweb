...
export default {
  ...
  methods: {
    ...
    allThisYearFirstLoad() {
      ...
      service.getSevkiyatRaporHepsi(this.select_yil).then((data) => {
    ...
    isAllSelected() {
      if (this.isAll == true) {
        this.$store.dispatch("loadingBeginAct");
        service.getYuklemeAll().then((data) => {
          this.$store.dispatch("stok_rapor_list_load_act", data);
          this.ilk_tarih = false;
          this.son_tarih = false;
          this.is_excel = false;
    ...
    YilSecim(select_yil) {
      ...
      service.getSevkiyatRaporTekTarih(select_yil).then((data) => {
        this.$store.dispatch("stok_rapor_list_load_act", data);
        this.loading = false;
        this.ilk_tarih = false;
        this.son_tarih = false;
    ...
    rapor_tarih_suz_click() {
      if (this.son_tarih && !this.ilk_tarih) {
        ...
        service.getSevkiyatRaporTarih(tarih).then((data) => {
          this.$store.dispatch("stok_rapor_list_load_act", data);
          this.$store.dispatch("loadingEndAct");
      ...
      if (this.ilk_tarih && this.son_tarih) {
        ...
        service.getSevkiyatRaporIkiTarih(ilk_tarih, son_tarih).then((data) => {
          this.is_filter_sevkiyat = true;
          this.$store.dispatch("stok_rapor_list_load_act", data);
          this.$refs.sevkiyat_tablo.value = data;
          this.tablo_toplam_guncelle(data);
